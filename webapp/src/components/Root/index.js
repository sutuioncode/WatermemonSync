...
import { syncAppWithRemote } from "models/sync";
      ...
      <Router basename="/">
        <div className={style.root}>
          ...
          <div className={style.headerBtnGroup}>
            <Button
              title={
                <Link className={style.generateLink} to="/blog">
            ...
            <Button
              ...
              onClick={() =>
                syncAppWithRemote()
                  .then(() => alert("Sync Succeed"))
                  .catch(() => alert("Could not sync check the console"))
              }
            />
          </div>
              ...
              render={props =>
                ...
                (isShowPostList || props.match.params.blogId) && (
                  <div className={style.postList}>
                    <BackLink to="/blog" onClick={this.hidePostList}>
                      &lt; Back
                    </BackLink>
            ...
            <div className={style.wrapper}>
              <Switch>
                {!isGenerating && (
                  <React.Fragment>
                    <Route
                      path="/blog/:blogId/nasty"
                      render={props =>
                        (isShowMain || props.match.params.blogId) && (
                    ...
                    <Route
                      ...
                      render={props =>
                        (isShowMain || props.match.params.postId) && (
                          <div className={style.main}>
